...
func (h *mockCommRequestHandler) HandleBatchProcessRequest(ctx context.Context, requests []*common.Request, appState *common.ApplicationState, wasmModule []byte) ([]*common.UpdatePayload, []byte, *common.ApplicationState, []*common.DeanonymizationReport, error) {
	return nil, nil, nil, nil, apperrors.New(apperrors.CodeInternalFallback, "not implemented")
}
