...
//go:generate solc --via-ir --abi --bin ../../contracts/contracts/ProcessorEndpoint.sol --base-path ../.. --include-path ../../contracts/node_modules -o ../../contract_abis/ProcessorEndpointAbi --overwrite
