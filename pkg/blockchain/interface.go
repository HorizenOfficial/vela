...
type Client interface {
	...
	SubmitRequest(ctx context.Context, protocolVersion uint8, applicationId uint64, requestType common.RequestType, payload []byte, value *big.Int) (string, uint64, error)
	...
	GetUserEvents(ctx context.Context, privKey cryptotypes.PrivateKeyP521, applicationId uint64, fromBlock uint64, toBlock uint64, filter func([]byte) bool, stopAtFirst bool) ([][]byte, error)
