...
var BytesMetaData = bind.MetaData{
	ABI: "[]",
	ID:  "8796ace56c474229ac1e4cd8d130420c3f",
	Bin: "0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea2646970667358221220c5dc7853f08677d452a867f04eac81a3d74a3da317a3152525d5b39d72cc393d64736f6c634300081e0033",
}
...
func NewBytes() *Bytes {
	parsed, err := BytesMetaData.ParseABI()
	if err != nil {
		panic(errors.New("invalid ABI: " + err.Error()))
	}
	return &Bytes{abi: *parsed}
}

// Instance creates a wrapper for a deployed contract instance at the given address.
// Use this to create the instance object passed to abigen v2 library functions Call, Transact, etc.
func (c *Bytes) Instance(backend bind.ContractBackend, addr common.Address) *bind.BoundContract {
	return bind.NewBoundContract(addr, c.abi, backend, backend, backend)
}
...
var ECDSAMetaData = bind.MetaData{
	...
	Bin: "0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea264697066735822122056fde940bd55db8d514f5e827f47bbdf7748848b63f92d933b0f67dbd4cf8d3764736f6c634300081e0033",
}
...
var MathMetaData = bind.MetaData{
	...
	Bin: "0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea264697066735822122016a9645e9e2a997ac2b71f7fe97c531bc0cad2aa87a36388e8686d0259ce570064736f6c634300081e0033",
}
...
var MessageHashUtilsMetaData = bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"ERC5267ExtensionsNotSupported\",\"type\":\"error\"}]",
	ID:  "2a46deb1e6ec75a21a12c9c84a8059f39d",
	Bin: "0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea26469706673582212200aa8462698373725c6f8143b3ffab57e745b34f960601a00d5e5a719a36eabbf64736f6c634300081e0033",
}
...
// UnpackError attempts to decode the provided error data using user-defined
// error definitions.
func (messageHashUtils *MessageHashUtils) UnpackError(raw []byte) (any, error) {
	if bytes.Equal(raw[:4], messageHashUtils.abi.Errors["ERC5267ExtensionsNotSupported"].ID.Bytes()[:4]) {
		return messageHashUtils.UnpackERC5267ExtensionsNotSupportedError(raw[4:])
	}
	return nil, errors.New("Unknown error")
}

// MessageHashUtilsERC5267ExtensionsNotSupported represents a ERC5267ExtensionsNotSupported error raised by the MessageHashUtils contract.
type MessageHashUtilsERC5267ExtensionsNotSupported struct {
}

// ErrorID returns the hash of canonical representation of the error's signature.
//
// Solidity: error ERC5267ExtensionsNotSupported()
func MessageHashUtilsERC5267ExtensionsNotSupportedErrorID() common.Hash {
	return common.HexToHash("0xdb00f904774eb2c01c48f03b898f2a97ac4b7f0de1ac6e506fc45d89c69ac23c")
}

// UnpackERC5267ExtensionsNotSupportedError is the Go binding used to decode the provided
// error data into the corresponding Go error struct.
//
// Solidity: error ERC5267ExtensionsNotSupported()
func (messageHashUtils *MessageHashUtils) UnpackERC5267ExtensionsNotSupportedError(raw []byte) (*MessageHashUtilsERC5267ExtensionsNotSupported, error) {
	out := new(MessageHashUtilsERC5267ExtensionsNotSupported)
	if err := messageHashUtils.abi.UnpackIntoInterface(out, "ERC5267ExtensionsNotSupported", raw); err != nil {
		return nil, err
	}
	return out, nil
}
...
var NoAttestationTeeAuthenticatorMetaData = bind.MetaData{
	...
	Bin: "",
}
...
var SafeCastMetaData = bind.MetaData{
	...
	Bin: "0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea2646970667358221220d15bcdfa0b14f5b7bb77c8085477d8211e50ccbbf65d1225e47ed355d73f48a564736f6c634300081e0033",
}
...
var SignedMathMetaData = bind.MetaData{
	...
	Bin: "0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea26469706673582212203e9c80db25a4e5702f488c94f4a3034b18c0312a94b909fd695908d2fee3dead64736f6c634300081e0033",
}
...
var StringsMetaData = bind.MetaData{
	...
	Bin: "0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea2646970667358221220c65970685c013dfb26dd9f8457b6edf733643c4bb83e383563571c016c578d6964736f6c634300081e0033",
}
...
var StructsMetaData = bind.MetaData{
	...
	Bin: "0x608060405234601957600e601d565b603e60288239603e90f35b6023565b60405190565b5f80fdfe60806040525f80fdfea26469706673582212203a58f4101516d8ab2f26b5334775fc9889eeb3c1cb41627fba64bc5fd31dc3db64736f6c634300081e0033",
}
...
var UpdateEntryHashMetaData = bind.MetaData{
	...
	Bin: "0x608060405234601d57600e6021565b603e602c823930815050603e90f35b6027565b60405190565b5f80fdfe60806040525f80fdfea2646970667358221220bb691715d005de3dce1d1ddffea094d9ad678129be696b35bab0b08a948a961864736f6c634300081e0033",
}
