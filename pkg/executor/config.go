...
func LoadConfig() (*Config, error) {
	...
	if channelType == "vsock" {
		...
		adminChannelConnectionParams = common.VSockChannelConnectionParams{CID: 3, Port: uint32(adminServerPort)}
	} else {
		...
		adminChannelConnectionParams = common.TcpChannelConnectionParams{Ip: executorIpAddress, Port: uint32(adminServerPort)}
	}
