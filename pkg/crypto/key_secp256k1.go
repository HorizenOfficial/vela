...
*/
func GeneratePrivateKeySecp256k1() (*common.PrivateKeySecp256k1, error) {
...
func SavePrivateKeySecp256k1ToFileDER(privKey *common.PrivateKeySecp256k1, filename string) error {
...
func LoadPrivateKeySecp256k1FromFileDER(filename string) (*common.PrivateKeySecp256k1, error) {
...
func SavePrivateKeySecp256k1ToFilePEM(privKey *common.PrivateKeySecp256k1, filename string) error {
	derBytes := crypto.FromECDSA(privKey.PrivateKey)
	pemBlock := &pem.Block{
		Type:  "EC PRIVATE KEY",
		Bytes: derBytes,
...
func LoadPrivateKeySecp256k1FromFilePEM(filename string) (*common.PrivateKeySecp256k1, error) {
