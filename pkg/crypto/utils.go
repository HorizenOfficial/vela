...
// P521PublicKey is a public key with Elliptic Curve Diffie-Hellman over NIST P-521 curve.
type P521PublicKey struct {
	*ecdh.PublicKey
}

// P521PrivateKey is a private key with Elliptic Curve Diffie-Hellman over NIST P-521 curve.
type P521PrivateKey struct {
	*ecdh.PrivateKey
}

// PublicKey returns the public key associated with a private key.
func (p *P521PrivateKey) PublicKey() *P521PublicKey {
	return &P521PublicKey{p.PrivateKey.PublicKey()}
}
...
*/
func GeneratePrivateKeyP521() (*P521PrivateKey, error) {
	curve := ecdh.P521()
	newKey, err := curve.GenerateKey(rand.Reader)
	if err != nil {
		return nil, fmt.Errorf("failed to generate private key: %w", err)
	}
	return &P521PrivateKey{newKey}, nil
}
...
*/
func Encrypt(senderPrivKey *P521PrivateKey, receiverPubKey *P521PublicKey, message []byte) ([]byte, error) {
...
*/
func Decrypt(senderPubKey *P521PublicKey, receiverPrivKey *P521PrivateKey, message []byte) ([]byte, error) {
