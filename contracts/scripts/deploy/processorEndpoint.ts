...
async function deploy()  {
  ...
  const processorEndpoint = await ProcessorEndpoint.deploy(process.env.TEE_AUTHENTICATOR!, process.env.AUTHORITY_REGISTRY!, process.env.UPDATE_STATUS_OPERATOR!, process.env.ADMIN!);
